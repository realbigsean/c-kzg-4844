...
macro_rules! banana {
    ($mod_name:ident)  => {
        pub mod $mod_name {
            include!(concat!("generated_", stringify!($mod_name), ".rs"));
            ...
            impl KZGSettings {
                ...
                pub fn load_trusted_setup_file(file_path: PathBuf) -> Result<Self, Error> {
                    ...
                    let file_path = CString::new(file_path_bytes).map_err(|e| {
            ...
            mod tests {
                ...
                fn test_blob_to_kzg_commitment() {
                    ...
                    for test_file in test_files {
                        ...
                        let test: blob_to_kzg_commitment_test::Test =
                ...
                fn test_compute_kzg_proof() {
                    ...
                    for test_file in test_files {
                        let yaml_data = fs::read_to_string(test_file).unwrap();
                        let test: compute_kzg_proof::Test =
                            serde_yaml::from_str(&yaml_data).unwrap();
                ...
                fn test_compute_blob_kzg_proof() {
                    ...
                    for test_file in test_files {
                        let yaml_data = fs::read_to_string(test_file).unwrap();
                        let test: compute_blob_kzg_proof::Test =
                            serde_yaml::from_str(&yaml_data).unwrap();
                ...
                fn test_verify_kzg_proof() {
                    ...
                    for test_file in test_files {
                        let yaml_data = fs::read_to_string(test_file).unwrap();
                        let test: verify_kzg_proof::Test =
                            serde_yaml::from_str(&yaml_data).unwrap();
                ...
                fn test_verify_blob_kzg_proof() {
                    ...
                    for test_file in test_files {
                        let yaml_data = fs::read_to_string(test_file).unwrap();
                        let test: verify_blob_kzg_proof::Test =
                            serde_yaml::from_str(&yaml_data).unwrap();
                        ...
                        match KZGProof::verify_blob_kzg_proof(
                            blob,
                            commitment,
                            proof,
                            &kzg_settings,
                ...
                fn test_verify_blob_kzg_proof_batch() {
                    ...
                    for test_file in test_files {
                        let yaml_data = fs::read_to_string(test_file).unwrap();
                        let test: verify_blob_kzg_proof_batch::Test =
                            serde_yaml::from_str(&yaml_data).unwrap();
